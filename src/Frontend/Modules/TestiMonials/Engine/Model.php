...
class Model implements FrontendTagsInterface
{
    ...
    public static function getAll($limit = 10, $offset = 0)
    {
        ...
        $ids = array();
        $link = FrontendNavigation::getURLForBlock('TestiMonials', 'Detail');
        ...
        // get all tags
        $tags = FrontendTagsModel::getForMultipleItems('TestiMonials', $ids);
    ...
    public static function search(array $ids)
    {
        ...
        $detailUrl = FrontendNavigation::getURLForBlock('testimonials', 'detail');
