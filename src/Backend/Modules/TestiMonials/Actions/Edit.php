    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            if ($this->frm->isCorrect()) {
                ...
                // edit searchindex
                BackendSearchModel::saveIndex('testimonials', $item['id'], array('title' => $item['title'], 'introduction' => $item['introduction'], 'text' => $item['text']));

                // trigger an event
                BackendModel::triggerEvent('testimonials', 'after_edit', $item);
