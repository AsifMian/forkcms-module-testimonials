<?php
namespace Backend\Modules\TestiMonials\Cronjobs;
...
class SendMostAwesome extends BackendBaseCronjob
{
    public function execute()
    {
        ...
        $items = BackendTestiMonialsModel::getTopAwesome();
        $str = '';
        ...
        $tpl = BACKEND_MODULES_PATH.'/TestiMonials/Layout/Templates/Mails/Send_top_awesome.tpl';
